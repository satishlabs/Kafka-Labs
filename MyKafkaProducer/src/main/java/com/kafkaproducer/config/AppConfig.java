...
public class AppConfig {
	...
	/*
	 * public ProducerFactory<String, Order> orderProducerFactory(){ Map<String,
	...
	/*
	 * @Bean(name = "orderKafkaTemplate") public KafkaTemplate<String, Order>
	 * orderKafkaTemplate(){ return new KafkaTemplate<String,
